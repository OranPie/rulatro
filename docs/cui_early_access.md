...
> Status: Active
> Audience: Players, UI developers, QA
...
- `rulatro-cui` now includes a dedicated Details pane that follows current focus/cursor (hand/shop/pack/inventory/events) for faster context-aware actions.
